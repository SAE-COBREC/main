(function () {
    ...
    function notify(message, type, opts) {
        ...
        t.innerHTML = iconFor(kind) + '<div class="toast-text"></div><button class="toast-close" title="Fermer">×</button>';
