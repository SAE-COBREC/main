...
<main class="a-propos-container">
    ...
    <section class="project">
        ...
        <p><strong>Dépôt Git :</strong> <a href="https://github.com/SAE-COBREC/main.git" target="_blank"
                rel="noopener">https://github.com/SAE-COBREC/main.git</a></p>
        <p><strong>Propriétaire du dépôt :</strong> SAE-COBREC</p>
    </section>

    <section>
        <h2>Contact</h2>
        <p>Pour toute question liée au projet ou aux données personnelles, écrivez à <a
                href="mailto:privacy@Alizon.fr">privacy@Alizon.fr</a>.</p>
    </section>
    ...
    <section>
        ...
        <div class="team-grid">
            <div class="card">
                ...
                <div>
                    <h3><a href="https://github.com/Klaynight-dev" target="_blank" rel="noopener">Elouan Passereau</a>
                    </h3>
            ...
            <div class="card">
                ...
                <div>
                    <h3><a href="https://github.com/gaetanlollieric" target="_blank" rel="noopener">Gaëtan Lollieric</a>
                    </h3>
