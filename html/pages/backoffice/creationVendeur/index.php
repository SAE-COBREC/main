    ...
    <form action="index.php" method="post" enctype="multipart/form-data" id="multiForm">
        ...
        <div class="card" id="1">
            ...
            <div>
                ...
                <input type="text" id="Rsociale" name="Rsociale" placeholder="Votre Raison sociale" maxlength="254"
                    required>
            </div>

            <div>
                <label for="Denomination">Denomination</label>
                <input type="text" id="Denomination" name="Denomination" placeholder="Votre Denomination"
                    maxlength="254" required>
            </div>

            <div>
                <label for="SIREN">N° SIREN</label>
                <input type="text" id="SIREN" name="SIREN" placeholder="numéro SIREN"
                    pattern="^(?:[0-9]{9}|[0-9]{3} [0-9]{3} [0-9]{3})$" inputmode="numeric" maxlength="11"
                    title="9 chiffres ou format 123 456 789" required>
            </div>

            <div class="debutant">Retour a la page de <a href="../connexionVendeur/index.php"><strong>Connexion
                        →</strong></a></div>
