...
<body>
            ...
            <section class="graphique-filtre">
                ...
                <div id="divSelectArticle">
                    ...
                    <select id="articleEvolution">
                        ...
                        <option value="<?php echo htmlspecialchars($art) ?>"><?php echo htmlspecialchars($art) ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                    <div>
    ...
    function chargerLesStats() {
        ...
        .value; //mode affiche corresponde a année ou période
        const type = document.getElementById('selectType')
        .value; //le type est si on veut en volume ou en nb de commande ou prix
