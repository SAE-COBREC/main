...
list($tousProduits, $categoriesDisponibles) = preparerTousLesProduits($listeProduits, $produitsHorsCatalogue);
...
$produitsFiltres = filtrerProduitsCatalogueVendeur($tousProduits, $rechercheNom, $filtreStatut, $filtreCategorie);
$produitsFiltres = trierProduitsCatalogueVendeur($produitsFiltres, $triCatalogue);
