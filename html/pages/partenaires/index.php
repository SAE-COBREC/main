    ...
    <section class="partners-hero">
        <div class="container">
            ...
            <div class="hero-actions">
                <input id="partners-search" type="search" placeholder="Rechercher un partenaire..."
                ...
                <div class="partner-card-inner">
                    ...
                    <div class="partner-body">
                        ...
                        <div class="partner-actions">
                            ...
                            <button class="btn btn-primary" aria-disabled="true" title="Visite désactivée">Visite
                                désactivée</button>
                        </div>
                    </div>
                </div>
