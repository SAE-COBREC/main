            ...
            <div class="dateCode">
                ...
                <div>
                    ...
                    <input name="cvc" id="cvc" type="text" required maxlength="3" minlength="3" placeholder="CVC"
                        value="<?php echo old('dateExpiration')?>" />
                </div>
            </div>
    ...
    <div id="cgvModal" class="modal hidden">
        <div class="modal-content">
            ...
            <div class="cgv-content">
                ...
                <p>Les présentes Conditions Générales de Vente (ci-après « CGV ») régissent les relations commerciales
                    entre les vendeurs tiers (ci-après les « Vendeurs ») et les acheteurs (ci-après les « Clients ») sur
                    la marketplace Alizon (ci-après la « Marketplace »), exploitée par la COBREC, SCOP SARL au capital
                    de 99 999 999 999 999 999 999 999 999 999 999 999 999 999 999 999 999 999 999,69 €, immatriculée au
                    RCS Paris sous le numéro 123 456 789, dont le siège social est situé 7 Rue Édouard Branly, 22300
                    Lannion, France.</p>
                <p>La passation de toute commande via la Marketplace Alizon emporte acceptation pleine, entière, non
                    équivoque et non viciée des présentes CGV, qui prévalent sur tout autre document émanant du Client.
                </p>

                <h3>ARTICLE 2 : DÉFINITIONS</h3>
                <p><strong>Opérateur :</strong> la société COBREC, exploitant partie technique et commerciale de la
                    Marketplace.</p>
                <p><strong>Vendeur :</strong> tout professionnel proposant des produits et/ou services via la
                    Marketplace.</p>
                <p><strong>Client / Acheteur :</strong> toute personne physique ou morale passant commande sur la
                    Marketplace.</p>
                <p><strong>Fiche Produit :</strong> page de présentation d'un produit, comprenant notamment ses
                    caractéristiques, son prix, les modalités de livraison et l'identité du Vendeur.</p>

                <h3>ARTICLE 3 : RÔLE DE L'OPÉRATEUR</h3>
                <p>L'Opérateur met à disposition une plateforme technique permettant la mise en relation entre Vendeurs
                    et Clients. Le contrat de vente est conclu directement entre le Vendeur et le Client. L'Opérateur
                    n'est pas partie au contrat de vente et n'assume pas la qualité de Vendeur, sauf indication expresse
                    contraire pour certains produits. Les conditions particulières de chaque Vendeur et la Fiche Produit
                    complètent les présentes CGV pour former le contrat applicable à chaque commande.</p>

                <h3>ARTICLE 4 : PRODUITS ET INFORMATIONS PRÉCONTRACTUELLES</h3>
                <p>Chaque fiche produit mentionne au minimum : les caractéristiques essentielles du produit, le prix
                    toutes taxes comprises (TTC), les frais, modes et délais de livraison, les éventuelles restrictions
                    de livraison et l'identité et les coordonnées du vendeur.</p>
                <p>Le vendeur est seul responsable de l'exactitude et de la mise à jour des informations figurant sur
                    ses produits.</p>
                ...
                <ul>
                    <li>Sélection des produits : le Client sélectionne un ou plusieurs produits et les ajoute à son
                        panier.</li>
                    <li>Accès au panier : le Client consulte le récapitulatif de son panier (prix, quantités, frais de
                        livraison estimés, Vendeurs concernés).</li>
                    <li>Identification / création de compte : le Client s'identifie ou crée un compte utilisateur et
                        saisit/valide ses coordonnées de facturation et de livraison.</li>
                    <li>Choix du mode de livraison : le Client choisit les modes de livraison proposés par chaque
                        Vendeur.</li>
                    <li>Première validation (1er clic) : le Client valide le panier et accède à une page de
                        récapitulatif de commande détaillée.</li>
                </ul>
                <p><strong>5.2 Page de récapitulatif et double clic</strong></p>
                <p>Avant le paiement, une page de synthèse affiche de manière claire : les produits commandés, leur
                    quantité et leur prix unitaire ; le montant total TTC, ventilé par Vendeur si nécessaire ; les frais
                    et modes de livraison ; l'adresse de livraison et de facturation ; le moyen de paiement choisi ; un
                    lien vers les présentes CGV et, le cas échéant, les conditions spécifiques du Vendeur.</p>
                <p>Le Client doit : vérifier l'exactitude de l'ensemble des informations ; Confirmer avoir pris
                    connaissance et accepter les CGV (case à cocher) ; Cliquer sur le bouton de validation conduisant au
                    paiement.</p>
                <p>Cette action constitue le premier clic d'acceptation. Le Client est ensuite redirigé vers l'interface
                    de paiement sécurisé, où il saisit ses données de paiement et confirme le règlement. La confirmation
                    définitive du paiement par un nouveau clic constitue le second clic. Le contrat de vente est
                    considéré comme conclu à l'issue de ce double clic (validation du récapitulatif puis confirmation du
                    paiement), manifestant le consentement ferme et définitif du Client sur le contenu de la commande et
                    l'obligation de paiement.</p>

                <h3>ARTICLE 6 : ACCUSÉ DE RÉCEPTION ET CONFIRMATION DE COMMANDE</h3>
                <p>Après validation du paiement, le Client reçoit un accusé de réception de commande par courrier
                    électronique, récapitulant la commande (produits, prix, frais de livraison, coordonnées, Vendeurs,
                    numéro de commande).</p>
                <p>Le cas échéant, un ou plusieurs emails de confirmation d'expédition émis par chaque Vendeur lorsque
                    les produits sont remis au transporteur.</p>
                <p>L'email d'accusé de réception ne vaut pas toujours acceptation définitive de la commande par le
                    Vendeur, notamment en cas d'erreur manifeste (affichage d'un prix dérisoire, indisponibilité
                    exceptionnelle, fraude présumée). Le Vendeur peut annuler la commande dans ces cas limitatifs, après
                    en avoir informé le Client. Les emails sont conservés à titre de preuve de la transaction. Le Client
                    est invité à les archiver sur un support durable.</p>

                <h3>ARTICLE 7 : PRIX ET PAIEMENT</h3>
                <p>Les prix affichés sur la Marketplace sont exprimés en euros et s'entendent toutes taxes comprises.
                    Les frais de livraison éventuels sont indiqués avant la confirmation définitive de la commande. Le
                    paiement est effectué via des solutions sécurisées proposées par l'Opérateur. Le Client garantit
                    qu'il dispose des autorisations nécessaires pour utiliser le moyen de paiement choisi. Une
                    commission de [X] % du montant de chaque commande est prélevée par l'Opérateur auprès du Vendeur au
                    titre du service de mise en relation.</p>

                <h3>ARTICLE 8 : LIVRAISON</h3>
                <p>Les modalités, délais et coûts de livraison sont indiqués sur chaque Fiche Produit et rappelés lors
                    du parcours de commande. Le Vendeur est seul responsable de l'organisation et de la bonne exécution
                    de la livraison des produits au Client. En cas de retard, perte de colis ou produit endommagé, le
                    Client doit se rapprocher du Vendeur via les outils de messagerie mis à disposition sur la
                    Marketplace.</p>

                <h3>ARTICLE 9 : DROIT DE RÉTRACTATION</h3>
                <p>Lorsque la loi le prévoit, le Client consommateur dispose d'un délai de 14 jours à compter de la
                    réception de son produit pour exercer son droit de rétractation, sans avoir à motiver sa décision ni
                    à supporter d'autres coûts que ceux prévus par la loi. Les modalités d'exercice du droit de
                    rétractation (adresse de retour, formulaire, prise en charge des frais de renvoi, exclusions
                    légales) sont précisées par chaque Vendeur et rappelées au Client lors de la commande.</p>

                <h3>ARTICLE 10 : GARANTIES</h3>
                <p>Les produits vendus via la Marketplace bénéficient des garanties légales applicables (garantie légale
                    de conformité, garantie des vices cachés) et, le cas échéant, de garanties commerciales
                    complémentaires accordées par le Vendeur ou le fabricant. Le Client adresse ses demandes au Vendeur
                    concerné via la messagerie de la Marketplace ou aux coordonnées indiquées sur la Fiche Produit.</p>

                <h3>ARTICLE 11 : RÉCLAMATIONS, LITIGES ET MÉDIATION</h3>
                <p>Pour toute question ou réclamation relative à un produit, à la livraison ou à la facturation, le
                    Client contacte en priorité le Vendeur concerné via la messagerie de la Marketplace. En cas de
                    litige persistant, le Client pourra recourir à un dispositif de médiation de la consommation
                    lorsqu'il y a lieu, selon les modalités précisées dans l'espace d'information légale de la
                    Marketplace.</p>

                <h3>ARTICLE 12 : DONNÉES PERSONNELLES</h3>
                <p>Dans le cadre de la gestion de Alizon et du traitement des commandes, l'Opérateur collecte et traite
                    des données à caractère personnel concernant les Clients et les Vendeurs. Ces traitements sont
                    réalisés conformément à la réglementation applicable et notamment au RGPD. Les finalités, durées de
                    conservation, droits des personnes et modalités d'exercice de ces droits sont détaillés dans les
                    mentions légales accessibles sur la Marketplace.</p>

                <h3>ARTICLE 13 : DROIT APPLICABLE ET JURIDICTION COMPÉTENTE</h3>
                <p>Les présentes CGV sont soumises au droit français. Sous réserve des règles d'ordre public
                    applicables, tout litige relatif à leur interprétation, leur exécution ou leur validité sera soumis
                    aux tribunaux compétents.</p>
            </div>
