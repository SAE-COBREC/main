...
<body>
    ...
    <aside>
        <table>
            ...
            <tr>
                <td>Référence de paiement : <?php echo $_SESSION["post-achat"]["facture"]["id_facture"]; ?></td>
            </tr>
            <tr>
                <td>Vendu par Alizon</td>
            </tr>
        </table>
        <hr>
        <table>
            <tr>
                ...
                <td><?php echo date('j F Y H:m', strtotime($_SESSION["post-achat"]["panier"]["timestamp_commande"])); ?>
                </td>
            </tr>
            <tr>
                <td>Total à payer</td>
