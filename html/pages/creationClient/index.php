...
<body>
  ...
  <div id="cgvModal" class="modal hidden">
    <div class="modal-content">
      <h2>CONDITION GÉNÉRALES D’UTILISATIONS</h2>
      <div class="cgu-content">
        <h3>1. OBJET</h3>
        <p>Alizon est un marketplace proposant à des tiers de mettre en avant des produits ainsi que les vendres. L’utilisation du service implique l’acceptation des présentes CGU.</p>

        <h3>2. COMPTE UTILISATEUR</h3>
        <p>Vous êtes responsable de la confidentialité de vos identifiants et mots de passe. Vous garantissez l’exactitude des informations fournies.</p>

        <h3>3. CONTENU</h3>
        <p>Interdiction de publier des contenus illégaux, haineux, diffamatoires, contrefaisants ou nuisibles. Le contenu que vous publiez reste sous votre responsabilité.</p>

        <h3>4. PROPRIÉTÉ INTELLECTUELLE</h3>
        <p><strong>Vos droits :</strong> Vous conservez vos droits sur vos contenus. Vous nous accordez une licence limitée pour l’affichage et l’hébergement nécessaires à la fourniture du service. Nous nous engageons à respecter vos droits et à ne pas utiliser vos contenus à d’autres fins que celles prévues par le service.</p>
        <p><strong>Droits de Alizon :</strong> Le code source de Alizon appartient exclusivement à la SCOP SARL COBREC, all rights reserved (tous droits réservés). Les autres éléments du site (textes, images, logos, icônes) sont la propriété de la SCOP SARL COBREC ou de ses partenaires et sont protégés. Toute reproduction non autorisée est interdite. Pour toute demande de licence ou de réutilisation, contactez-nous à contact@alizon.bzh.</p>
        <p><strong>Engagement de l'utilisateur :</strong> L'utilisateur s'engage à respecter les droits de propriété intellectuelle (droit d'auteur, droits voisins du droit d’auteur, droit des marques et des logos). Il s'engage à n'utiliser que des images ou autres éléments dont il détient légalement les droits ou pour lesquels il dispose d’une autorisation expresse des titulaires.</p>

        <h3>5. SUSPENSION ET RÉSILIATION</h3>
        ...
        <p>Le service est fourni « en l’état ». Nous ne garantissons pas une disponibilité ininterrompue. Notre responsabilité ne saurait être engagée pour des dommages indirects.</p>

        <h3>7. DONNÉES PERSONNELLES</h3>
        <p>Le traitement des données est décrit dans les mentions légales. En vous inscrivant sur Alizon, vous acceptez expressément ces traitements et confirmez avoir pris connaissance des mentions légales.</p>
